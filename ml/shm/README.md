...
Owner: **Agent C**. Implement **S1-S4** from [plan.md](../../plan.md), following [the shared contract](../../contracts/model.md).
...
- Output: `shm_predictions.csv` in the organiser's schema.
...
```text
python -m ml.shm.train --help
python -m ml.shm.evaluate --help
